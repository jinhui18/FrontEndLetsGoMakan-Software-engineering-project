...
//This class is obsolete (replaced by StoreAccountModel
            ...
            mAuth.createUserWithEmailAndPassword(email, password)
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            //Testing
                                Restaurant r1 = new Restaurant(true, (float) 1, 5, (float) 50, "KFC", "76 Nanyang Dr, #01-04 NTU North Spine Plaza, Singapore 637331", 1.34729, 103.68080, "Sedapz", "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0a/Green_Dot_logo.svg/1200px-Green_Dot_logo.svg.png", 12, TypesOfDietaryRequirements.NONE);
                                Restaurant r2 = new Restaurant(true, (float) 2, 4, (float) 45, "McDonald's", "76 Nanyang Drive, #01-08, NTU Block N2, #1, Singapore 637331", 1.347197787082023, 103.68036145503535, "Sedapz", "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0a/Green_Dot_logo.svg/1200px-Green_Dot_logo.svg.png", 12, TypesOfDietaryRequirements.HALAL);
                                Restaurant r3 = new Restaurant(true, (float) 3, 3, (float) 20, "Fine Foods @ South Spine", "21 Nanyang Link, School of Physical and Mathematical Sciences, Singapore 637371", 1.3426046619494159, 103.68236527841667, "Sedapz", "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0a/Green_Dot_logo.svg/1200px-Green_Dot_logo.svg.png", 12, TypesOfDietaryRequirements.VEGETARIAN);
                                Restaurant r4 = new Restaurant(true, (float) 4, 2, (float) 2, "AlsoAnotherRestaurant", "Woodlands", 0.00, 0.00, "Sedapz", "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0a/Green_Dot_logo.svg/1200px-Green_Dot_logo.svg.png", 12, TypesOfDietaryRequirements.BOTH);
